...
const Sidebar = () => {
    ...
    const menuItems = [
        { text: 'Dashboard', path: projectKey ? `/dashboard/${projectKey}` : '/dashboard' },
...
{ text: 'Code Viewer', path: projectKey ? `/code-viewer/${projectKey}` : '/dashboard' },
        ...
        { text: 'Issues Explorer', icon: <AlertCircle size={20} />, path: '/issues/:projectKey' },
        { text: 'Code Viewer', icon: <Code size={20} />, path: '/code-viewer/:projectKey' },
