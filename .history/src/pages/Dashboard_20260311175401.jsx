    ...
    <Grid container spacing={3}<Grid container spacing={3} alignItems="stretch">>
        ...
        <Grid item xs={12} md={7}>
            <Card className="stat-card" sx={{ height: '100%', minHeight: 450 }}>
                <CardContent sx={{ p: 0 }}>
                    <Box
                        sx={{ p: 3, borderBottom: '1px solid #f1f5f9', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Box>
                            <Typography variant="h6" sx={{ fontWeight: 700, color: '#1e293b' }}>
                                Recent Projects
                            </Typography>
                    ...
                    <TableContainer>
                        <Table sx={{ minWidth: 650 }} aria-label="recent projects table">
                            <TableHead sx={{ bgcolor: '#f8fafc' }}>
                                <TableRow>
                                    <TableCell align="center" sx={{ color: '#94a3b8', fontWeight: 700 }}>PROJECT KEY
                                    </TableCell>
                                    <TableCell align="center" sx={{ color: '#94a3b8', fontWeight: 700 }}>PROJECT NAME
                                    </TableCell>
                                    <TableCell align="center" sx={{ color: '#94a3b8', fontWeight: 700 }}>DESCRIPTION
                                    </TableCell>
                                    <TableCell align="center" sx={{ color: '#94a3b8', fontWeight: 700 }}>ACTION
                                    </TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                ...
                                <TableRow key={row.id} hover sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                    ...
                                    <TableCell
                                        sx={{ color: '#94a3b8', fontWeight: 700, fontSize: '0.75rem', letterSpacing: '0.05em' }}>
                                        {row.name}</TableCell>
                                    ...
                                    <TableCell align="right">
                                        <Box sx={{ display: "flex", justifyContent: "flex-end", gap: 1 }}>
                                            ...
                                            <Button size="small" color="error"
                                                sx={{ textTransform: "none", fontWeight: 600 }} onClick={()=>
                                                deleteProject(row.projectKey)}
                                                >
                                                Delete
                                            </Button>
                                        </Box>
                                ...
                                <TableRow>
                                    <TableCell colSpan={3} align="center" sx={{ py: 8 }}>
                                        <Typography color="text.secondary">No projects found. Start a new analysis to
                                            see results.</Typography>
                                    </TableCell>
                                </TableRow>
                                )}
                            </TableBody>
