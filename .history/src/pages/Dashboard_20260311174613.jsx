...
import { Grid, Typography, Box, Card, CardContent, Button, Divider, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, LinearProgress, Avatar, Menu, MenuItem, CircularProgress } from '@mui/material';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
import { Bug, Shield, Play, TrendingUp, TrendingDown, Clock, Activity, ExternalLink, FolderOpen } from 'lucide-react';
                        ...
                        <CardContent sx={{ p: 0 }}>
                            ...
                            <TableContainer>
                                <Table sx={{ minWidth: 650 }} aria-label="recent projects table">
                                  ...
                                  <TableRow>
                                      <TableCell align="center" sx={{ color: '#94a3b8', fontWeight: 700 }}>PROJECT KEY</TableCell>
                                      <TableCell align="center" sx={{ color: '#94a3b8', fontWeight: 700 }}>PROJECT NAME</TableCell>
                                      <TableCell align="center" sx={{ color: '#94a3b8', fontWeight: 700 }}>DESCRIPTION</TableCell>
                                      <TableCell align="center" sx={{ color: '#94a3b8', fontWeight: 700 }}>ACTION</TableCell>
                                </TableRow>
                                </TableHead>
                                    <TableBody>
