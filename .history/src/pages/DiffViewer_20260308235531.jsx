...
<Box className="diff-content">
  ...
  <Box className="diff-side-container">

    {/* ORIGINAL COLUMN */}

    <Box className="diff-panel">

      <Box className="diff-panel-header removed-header">
        ORIGINAL
      </Box>

      <Box className="diff-code">

        {currentFile?.differences?.map(d => (

          <Box
            key={`${d.lineNumber}-orig`}
    ...
    <Box className="diff-panel">
      ...
      <Box className="diff-panel-header added-header">
        PROPOSED FIX
      </Box>
