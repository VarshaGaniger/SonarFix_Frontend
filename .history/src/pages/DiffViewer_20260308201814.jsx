...
const mapped = diffRes.data
  ...
  /* ---------------- FILE GROUPING ---------------- */
const hasIssueOnLine = (filePath, lineNumber) => {

  return issues.some(issue =>
    normalize(issue.file)?.endsWith(normalize(filePath)) &&
          ...
          <Box className="diff-container">
            ...
            <Box className="diff-column">
              ...
              <Box className="code-block">
                ...
                {currentFile?.differences
  ?.filter(d => hasIssueOnLine(currentFile.relativePath, d.lineNumber))
  .map(d => (
